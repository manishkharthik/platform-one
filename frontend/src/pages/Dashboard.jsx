...
import { Bell, Clock, User, Plus, TrendingUp, Target } from "lucide-react";
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-1 text-xs text-gray-400">
            <span>📅 {campaign.created_at ? new Date(campaign.created_at).toLocaleDateString("en-US", { month: "short", d: "numeric", year: "numeric" }) : "—"}</span>
